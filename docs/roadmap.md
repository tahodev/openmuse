...
- v0.6 isolated workers and approval UI; secrets broker and narrowing subagent grants landed; cron scheduler with atomic multi-worker claims landed; resource-limited OS process worker landed. Kernel/network isolation and a production approval UI remain.
